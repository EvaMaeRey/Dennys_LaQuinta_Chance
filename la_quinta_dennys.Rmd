...
Rg1 = Rg1 + geom_density(data = Rd, aes(x = dist, group = pair, color = pair, fill = pair), alpha = 0.3, na.rm=TRUE) + ggtitle("Random placement")

Rg2 = ggplot(Rd, aes(x = dist, color = pair)) + 
  xlab("Distance (km)") +
  ylab("ECDF") + xlim(0,300) + ggtitle("Random placement")#+scale_x_log10()
